...
public class BedroomCutscene : MonoBehaviour
{
    ...
    private IEnumerator FishCutscene()
    {
        ...
        dialogue.Add("...");
        dialogue.Add("Last week, witness, janitor, reported astringent green slime covering our school's gym.");
        dialogue.Add("...");
        dialogue.Add("Astute observation Fish! It's likely the culprit is a student. I'll have to be more wary of my delinquent peers.");
        dialogue.Add("Additionally, owner of the local bakery, John Buttz, claimed to have seen 'demons' in the back room of his establishment.");
        dialogue.Add("Further inspection revealed the dough contained traces of refuse and stool.");
        dialogue.Add("Health inspectors suspect Mr. Buttz has taken his name too seriously.");
        dialogue.Add("...");
        dialogue.Add("Local lawn and garden aficionados reported garden gnomes missing from their front lawns.");
        dialogue.Add("A few days later the gnomes' mutilated remains were found scattered across various other residences.");
        dialogue.Add("!");
        dialogue.Add("Barbaric, I know.");
